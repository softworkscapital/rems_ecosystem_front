...
const AddIncome = () => {
    ...
    const handleSubmit = (e) => {
        ...
        fetch(`${API_URL}/accountlinking/post/income`, {
            method: "POST",
    ...
    useEffect(() => {
        const accounts = () => {
            fetch(`${API_URL}/income/get/acc/limit`).then(res => {
                return res.json()
            }).then(resp => {
                                        ...
                                        <div class="card" style={{ width: '65%' }}>
                                            ...
                                            <div class="card-body">
                                                <form id="form" data-parsley-validate="" novalidate="" onSubmit={handleSubmit}>
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="fin_acc_account_map_id" class="col-3 col-lg-2 col-form-label text-right">To: </label>
                                                        <div class="col-9 col-lg-10">
                                                            <select
                                                                id="stage"
